      ...
      <div className='content'>
        <div className='back-image'>
          <svg width="1441" height="1024" viewBox="0 0 1441 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
            <line x1="623.861" y1="690.478" x2="645.355" y2="656.743" stroke="gray" stroke-width="10"/>
            <line x1="617.771" y1="662.83" x2="651.505" y2="684.324" stroke="gray" stroke-width="10"/>
            <line x1="358.861" y1="131.478" x2="380.355" y2="97.7436" stroke="gray" stroke-width="10"/>
            <line x1="352.771" y1="103.83" x2="386.505" y2="125.324" stroke="gray" stroke-width="10"/>
            <line x1="1193.11" y1="88.8841" x2="1231.23" y2="100.995" stroke="gray" stroke-width="3"/>
            <line x1="1218.24" y1="76.0779" x2="1206.13" y2="114.201" stroke="gray" stroke-width="3"/>
            <line x1="130.672" y1="853.899" x2="149.82" y2="848.124" stroke="gray" stroke-width="3"/>
            <line x1="137.977" y1="841.692" x2="143.752" y2="860.84" stroke="gray" stroke-width="3"/>
          </svg>          
        </div>
